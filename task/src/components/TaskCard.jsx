    ...
    <>
      <div className="task-card">
        ...
        <div className="task-actions">
          {editing ? (
            <>
              <button type="button"className="action-btn save" onClick={handleEdit}
              >
                Save
              </button>

              <button type="button" className="action-btn cancel" onClick={handleCancelEdit}
              >
                Cancel
              </button>
            </>
            ...
            <>
              <button type="button" className="action-btn toggle" onClick={() =>
